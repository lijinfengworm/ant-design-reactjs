 ...
 * 内部表格组件
 */
class InnerCapacityProvince extends React.PureComponent {
    	...
    	return (
    		<div>
	    		<Col span={8} className="row-list">
		        	<Card title={cad.name} bordered={false}  extra={<a href={'/#/capacity/capacitydetail?id='+cad.id}>详情</a>}>
...
export default InnerCapacityProvince;
