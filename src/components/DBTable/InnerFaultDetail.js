 ...
 * 内部表格组件
 */
class InnerFaultDetail extends React.PureComponent {
  ...
  render() {
    ...
    var faultTable = this.state.data.map(function(cad){
    	console.info(cad);
    		...
    		<div>
				...
				<div className="machine-process">
				    ...
				    <Row>
				      ...
				      <Step title={cad.process.data1.name} description={cad.process.data4.msg} />
					  </Steps>
				      </Col>
				    </Row>
				</div>
...
export default InnerFaultDetail;
