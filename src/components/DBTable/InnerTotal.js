...
class InnerTotal extends React.PureComponent {
  ...
  render() {
    ...
    var cardNodeTotal = this.state.data.map(function(cad){
        ...
        <Row>
          <Col xs={12} sm={12} md={12} lg={12} xl={12}>
            <div className="total-title-circle"><p>{cad.fault.left.name}</p></div>
            <div className="total-circle-list">
              <Progress type="circle" percent={cad.fault.left.value} strokeWidth ={7} width ={200}/>
            </div>
          </Col>
          <Col xs={12} sm={12} md={12} lg={12} xl={12}>
            <div className="total-title-circle"><p>{cad.fault.right.name}</p></div>
            <div className="total-line-list">
            {
        ...
        <Row>
          <Col xs={24} sm={24} md={24} lg={24} xl={24}>
            <div className="total-title-circle"><p>{cad.fault_count.name}</p></div>
        ...
        <Row>
          <Col xs={24} sm={24} md={24} lg={24} xl={24}>
            <div className="total-title-circle"><p>{cad.efficient.name1}</p></div>
    ...
    return (
      <div className="total-main" style={{ background: '#f8f8f8', padding: '30px' }}>
        {cardNodeTotal}
      </div>
    );
  }
