...
import {message, notification, Spin, Button} from 'antd';
import Error from '../Error';
import InnerForm from './InnerForm.js';
import InnerTable from './InnerTable.js';
import InnerList from './InnerList.js';
import InnerTotal from './InnerTotal.js';
import InnerFault from './InnerFault.js';
import InnerCapacity from './InnerCapacity.js';
import InnerCapacityProvince from './InnerCapacityProvince.js';
import InnerCapacityDetail from './InnerCapacityDetail.js';

import InnerFaultDetail from './InnerFaultDetail.js';
import InnerQueryMachine from './InnerQueryMachine.js';
...
class DBTable extends React.PureComponent {
  ...
  render() {
    ...
    //设备详情
    if(this.tableName == 'queryMachine'){
      return (
        <Spin spinning={this.state.loadingSchema} delay={500}>
    ...
    //故障详情
    if(this.tableName == 'faultDataDetail'){
      return (
        <Spin spinning={this.state.loadingSchema} delay={500}>
    ...
    //各省产能详情
    if(this.tableName == 'capacityDetailData'){
      return (
        <Spin spinning={this.state.loadingSchema} delay={500}>
